...
public class MyViewModel extends AndroidViewModel {
    ...
    private static final String SAVE_SHP_NAME = "save_shp_name";
    ...
    public MyViewModel(@NonNull Application application, SavedStateHandle handle) {
        ...
        if (!handle.contains(KEY_HIGH_SCORE)) {
            SharedPreferences shp = getApplication()
                    .getSharedPreferences(SAVE_SHP_NAME, Context.MODE_PRIVATE);
    ...
    public void save() {
        SharedPreferences shp = getApplication().getSharedPreferences(SAVE_SHP_NAME, Context.MODE_PRIVATE);
